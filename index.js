...
var languageStrings = {
    'en': {
        'translation': {
            'WELCOME' : "Welcome to the Cedar Point Guide!",
            'HELP'    : "Say about, to hear more about the park, or say coffee, breakfast, lunch, or dinner, to hear restaurant suggestions, or say recommend an attraction, or say, go outside. ",
            'ABOUT'   : "Cedar Point is an amusement park in Sandusky, Ohio. By far the best amusment park in the country.",
...
var data = {
    "questions" : [
        {
            "id":"01",
            "prompt":"Policies can be applied to:",
            "options": ["Only Roles", "Only Users and groups", "Users, groups and roles"],
...
var handlers = {
    ...
    'StartIntent': function () {
        var restaurant = randomArrayElement(getRestaurantsByMeal());
        this.attributes['question'] = restaurant.prompt;

        var say = 'For a great coffee shop, I recommend, ' + restaurant.prompt + '. Would you like to hear more?';
        this.emit(':ask', say);
    },
